...
public class CorsConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/api/v1") // Specify the mapping pattern you want to allow CORS for
                ...
                .allowedOrigins("https://hris-v1.netlify.app/") // Allow requests from this origin uncomment this line to run on localhost
    ...
    public CorsFilter corsFilter() {
        ...
        config.addAllowedOrigin("https://hris-v1.netlify.app/");
